...
if (!TEST_MONGODB_URI)
    throw new Error('TEST-DB URI missing');
if (!SECRET)
    throw new Error('SECRET missing');
if (!ADMIN_SECRET)
    throw new Error('ADMIN_SECRET missing');
if (!XIRSYS_SECRET)
    throw new Error('XIRSYS_SECRET missing');
if (!XIRSYS_URL)
    throw new Error('XIRSYS_URL missing');
if (!SENDGRID_API_KEY)
    throw new Error('SENDGRID_API_KEY missing');
if (!TWILIO_API_SECRET)
    throw new Error('TWILIO_API_SECRET missing');
if (!TWILIO_ACCOUNT_SID)
    throw new Error('TWILIO_ACCOUNT_SID missing');
if (!TWILIO_API_KEY)
    throw new Error('TWILIO_API_KEY missing');
exports.default = {
    PORT,
