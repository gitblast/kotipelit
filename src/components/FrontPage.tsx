    ...
    <div className={classes.mainContainer}>
      <Grid container className={classes.showcase}>
        ...
        <Grid item sm={5} xs={12}>
          <img className={classes.image} src={backgroundImg} alt="Background" />
        </Grid>
        <Grid item sm></Grid>
      </Grid>
      ...
      <Grid container spacing={2} className={classes.flexin}>
        ...
        <Grid item xs={12} sm={4}>
          ...
          <Typography variant="h5">
            ...
            toistensa sanoja vihjeiden avulla. Eniten pisteitä saa kun vain yksi
            arvaa sanan. Peli kestää noin tunnin ja pyörii pelaamiseen
